...
The **portfolio root** (all GitHub / live-app links, theory, programming tracks, Motel demo asset) lives at **[vgandhi1.github.io](https://vgandhi1.github.io/)** — it no longer duplicates this HTML under `interactive/`. This repository is the **only** published copy of these decks and tools, deployed as the `web-interactive-collection` GitHub Pages project site.

---

## 📂 Projects Included

### Vinay A Gandhi (VAG) Interactive Project Hub (`index.html`)
